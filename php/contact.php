...
if (!validarVariable($encuesta) ) {
  mandarError("1");
}

$correo_nuevo = new Correo("cuarenta.seafood@gmail.com",'Tienes una nueva respuesta a la encuesta');
$correo_nuevo->agregarCampos("Respuesta: ", $encuesta);
...
function mandarError($codigo_de_error)
{
  ...
  if ($GLOBALS["tipo_de_procesamiento"] == 0) {
    ...
    if($codigo_de_error == "0"){
        header('location: /encuesta/confirmacion.php?msj='. $codigo_de_error);
        exit;   
    }
  ...
  private function primeraParteDelCuerpo()
  {
    ...
    <html lang="es">
      <head>
        ...
        <title>Eencuesta Cuarenta</title>
        <style>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                        <tr>
                          <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Has recibido una nueva respuesta</p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Esta es la respuesta respecto a la nueva ubicación:</p>';
  }
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                  <tr>
                    <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                      <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">Copyright © 2023 Cuarenta Seafood. Todos los Derechos Reservados.</span>
